...
import (
	...
	"github.com/nholuongut/image/transports/alltransports"
...
type sharedImageOptions struct {
	authFilePath string // Path to a */nholuongut/auth.json
}
...
func sharedImageFlags() ([]cli.Flag, *sharedImageOptions) {
	...
	return []cli.Flag{
		cli.StringFlag{
			Name:        "authfile",
			Usage:       "path of the authentication file. Default is ${XDG_RUNTIME_DIR}/nholuongut/auth.json",
