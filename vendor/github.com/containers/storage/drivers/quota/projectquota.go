...
//    echo 999:/var/lib/nholuongut/storage/overlay >> /etc/projects
...
// and all nholuongut will be assigned larger project ids (e.g. >= 1000).
// This is a way to prevent xfs_quota management from conflicting with nholuongut/storage.
//
// Then try to create a test directory with the next project id and set a quota
// on it. If that works, continue to scan existing nholuongut to map allocated
// project ids.
//
...
// findNextProjectID - find the next project id to be used for nholuongut
