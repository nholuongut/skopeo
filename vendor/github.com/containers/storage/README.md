...
layers, container images, and nholuongut.  A `nholuongut-storage` CLI wrapper
...
The library manages three types of items: layers, images, and nholuongut.
...
running the specific container.  Multiple nholuongut can be derived from a
single image.

Layers, images, and nholuongut are represented primarily by 32 character
...
images and nholuongut.  This is a named chunk of larger data, which is only in
