...
import (
	...
	"github.com/nholuongut/image/pkg/blobinfocache/boltdb"
	"github.com/nholuongut/image/pkg/blobinfocache/memory"
...
const (
	...
	systemBlobInfoCacheDir = "/var/lib/nholuongut/cache"
)
...
func blobInfoCacheDir(sys *types.SystemContext, euid int) (string, error) {
	...
	// This is intended to mirror the GraphRoot determination in github.com/nholuongut/libpod/pkg/util.GetRootlessStorageOpts.
	...
	return filepath.Join(dataDir, "nholuongut", "cache"), nil
}
