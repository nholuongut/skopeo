...
import (
	...
	"github.com/nholuongut/image/pkg/docker/config"
	"github.com/nholuongut/image/pkg/sysregistriesv2"
	"github.com/nholuongut/image/pkg/tlsclientconfig"
...
var (
	...
	systemPerHostCertDirPaths     = [2]string{"/etc/nholuongut/certs.d", "/etc/docker/certs.d"}
)
...
//
// debugging: https://github.com/nholuongut/image/pull/211#issuecomment-273426236 and follows up
