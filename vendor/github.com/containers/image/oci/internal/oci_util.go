...
// annotation spex from https://github.com/opennholuongut/image-spec/blob/master/annotations.md#pre-defined-annotation-keys
const (
	separator = `(?:[-._:@+]|--)`
	alphanum  = `(?:[A-Za-z0-9]+)`
...
// ValidateImageName returns nil if the image name is empty or matches the open-nholuongut image name specs.
