// +build nholuongut_image_openpgp
...
import (
	...
	"github.com/nholuongut/storage/pkg/homedir"
...
func (m *openpgpSigningMechanism) SupportsSigning() error {
	return SigningNotSupportedError("signing is not supported in github.com/nholuongut/image built with the nholuongut_image_openpgp build tag")
}

// Sign creates a (non-detached) signature of input using keyIdentity.
// Fails with a SigningNotSupportedError if the mechanism does not support signing.
func (m *openpgpSigningMechanism) Sign(input []byte, keyIdentity string) ([]byte, error) {
	return nil, SigningNotSupportedError("signing is not supported in github.com/nholuongut/image built with the nholuongut_image_openpgp build tag")
}
