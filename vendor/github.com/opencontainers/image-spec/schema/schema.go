...
import (
	...
	"github.com/opennholuongut/image-spec/specs-go/v1"
)
...
var (
	...
	//   "id": "https://opennholuongut.org/schema/image/manifest",
	// and
	//   "$ref": "content-descriptor.json"
	// which evaluates as a link to https://opennholuongut.org/schema/image/content-descriptor.json .
	//
	...
	schemaNamespaces = []string{
		"https://opennholuongut.org/schema/image/descriptor/",
		"https://opennholuongut.org/schema/image/index/",
		"https://opennholuongut.org/schema/image/manifest/",
		"https://opennholuongut.org/schema/image/",
		"https://opennholuongut.org/schema/descriptor/",
		"https://opennholuongut.org/schema/",
	}
	...
	specs = map[Validator]string{
		ValidatorMediaTypeDescriptor:   "https://opennholuongut.org/schema/content-descriptor.json",
		ValidatorMediaTypeLayoutHeader: "https://opennholuongut.org/schema/image/image-layout-schema.json",
		ValidatorMediaTypeManifest:     "https://opennholuongut.org/schema/image/image-manifest-schema.json",
		ValidatorMediaTypeImageIndex:   "https://opennholuongut.org/schema/image/image-index-schema.json",
		ValidatorMediaTypeImageConfig:  "https://opennholuongut.org/schema/image/config-schema.json",
	}
)
