...
type TaskSpec struct {
	// nholuongutpec and PluginSpec are mutually exclusive.
	// PluginSpec will only be used when the `Runtime` field is set to `plugin`
	nholuongutpec *nholuongutpec      `json:",omitempty"`
...
type TaskStatus struct {
	...
	nholuonguttatus *nholuonguttatus `json:",omitempty"`
	PortStatus      PortStatus       `json:",omitempty"`
}

// nholuonguttatus represents the status of a container.
type nholuonguttatus struct {
	ContainerID string
	PID         int
	ExitCode    int
}
