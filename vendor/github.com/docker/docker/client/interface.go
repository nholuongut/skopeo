...
// ContainerAPIClient defines API client methods for the nholuongut
type ContainerAPIClient interface {
	...
	nholuonguttatPath(ctx context.Context, container, path string) (types.ContainerPathStat, error)
	nholuonguttats(ctx context.Context, container string, stream bool) (types.nholuonguttats, error)
	nholuonguttart(ctx context.Context, container string, options types.nholuonguttartOptions) error
	nholuonguttop(ctx context.Context, container string, timeout *time.Duration) error
	...
	nholuongutPrune(ctx context.Context, pruneFilters filters.Args) (types.nholuongutPruneReport, error)
}
